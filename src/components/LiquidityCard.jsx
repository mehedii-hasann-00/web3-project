...
export default function LiquidityCard({tokenAddress,usdtAddress,name,symbol,networkInfo}) {
  return (
    <div className="w-full max-w-lg bg-gray-800 p-8 rounded-lg shadow-lg text-white">
      ...
      <div className="bg-gray-700 p-3 rounded-md text-sm mb-4">
        ...
        <p><strong>USDT Address:</strong> {usdtAddress ? usdtAddress :'Not available'}</p>
      </div>
